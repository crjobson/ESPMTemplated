sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("espm/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("espm.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["espm/localService/mockserver"], function (mockserver) {
