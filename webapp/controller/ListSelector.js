sap.ui.define([
		...
		return BaseObject.extend("espm.model.ListSelector", {
			 ...
			 * @return {espm.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
